...
exports.associations = function () {
  var _ = require('lodash');
  waterlock.User.hasMany(waterlock.Attempt, {as: 'attempts',foreignKey: 'attempt_uid',onDelete:'CASCADE'});
  waterlock.User.hasMany(waterlock.Jwt, {as: 'jsonWebTokens',foreignKey: 'jwt_uid',onDelete:'CASCADE'});
  waterlock.User.hasMany(waterlock.Auth, {as: 'auths',foreignKey: 'auth_uid',onDelete:'CASCADE'});
};
