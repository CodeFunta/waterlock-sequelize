...
exports.associations = function () {
  var _ = require('lodash');
  waterlock.User.hasMany(waterlock.Attempt, {as: 'attempts',foreignKey: 'fk_attempts'});
  waterlock.User.hasMany(waterlock.Jwt, {as: 'jsonWebTokens',foreignKey: 'fk_jwts'});
  waterlock.User.hasOne(waterlock.Auth, {as: 'auth',foreignKey: 'fk_auth'});
};
